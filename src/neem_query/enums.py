...
class ColumnLabel(Enum):
    ...
    performer_frame_id = "performer_frame_id"
    participant_frame_id = "participant_frame_id"
    performer_child_frame_id = "performer_child_frame_id"
    participant_child_frame_id = "participant_child_frame_id"
    performer_stamp = "performer_stamp"
    participant_stamp = "participant_stamp"
    performer_translation_x = "performer_x"
    performer_translation_y = "performer_y"
    performer_translation_z = "performer_z"
    performer_orientation_x = "performer_qx"
    performer_orientation_y = "performer_qy"
    performer_orientation_z = "performer_qz"
    performer_orientation_w = "performer_qw"
    participant_translation_x = "participant_x"
    participant_translation_y = "participant_y"
    participant_translation_z = "participant_z"
    participant_orientation_x = "participant_qx"
    participant_orientation_y = "participant_qy"
    participant_orientation_z = "participant_qz"
    participant_orientation_w = "participant_qw"
